...
SaveName = '2025Ops'
	# • Nick to send list of numbers for reporting
	# • Add hollow box and add size for time within band
	# • Re-do ndays within temp bands with biological bands
#  Multiple panes per year for biological bands
for(i in 1:length(sb)){
    # Left off here, problem with names for MFWill with i = 4 , line 366
